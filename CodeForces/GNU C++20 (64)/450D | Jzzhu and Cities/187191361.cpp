...
#define endl '\n'
#define PII   pair<logn long,unsigned long long>
#define PPII  pair<unsigned long long,pair<unsigned long long,unsigned long long>>
priority_queue<PPII,vector<PPII>,greater<PPII>> pq;
vector<pair<unsigned long long,pair<unsigned long long,unsigned long long>>> Adj[100001];
bool vis[100001]={};
